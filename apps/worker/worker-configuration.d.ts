/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 74bd316f38753d1a28f015550418f2ab)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		ORG_EMAIL_DOMAIN: "assets.com";
		SYSTEM_ADMIN_EMAILS: "admin@assets.com";
		CLERK_ISSUER: "https://definite-griffon-89.clerk.accounts.dev";
		CLERK_JWKS_URL: "https://definite-griffon-89.clerk.accounts.dev/.well-known/jwks.json";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORG_EMAIL_DOMAIN" | "SYSTEM_ADMIN_EMAILS" | "CLERK_ISSUER" | "CLERK_JWKS_URL">> {}
}
