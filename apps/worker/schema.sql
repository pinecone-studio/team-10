...
CREATE TABLE IF NOT EXISTS users (
  ...
  role TEXT NOT NULL CHECK (role IN ('EMPLOYEE', 'INVENTORY_HEAD', 'FINANCE', 'IT_ADMIN', 'HR_MANAGER', 'SYSTEM_ADMIN')),
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  power_spec TEXT,
  condition_note TEXT,
  receive_status TEXT NOT NULL DEFAULT 'PENDING' CHECK (receive_status IN ('PENDING', 'RECEIVED')),
  received_at TEXT,
  received_by INTEGER,
  assigned_to INTEGER,
  assigned_at TEXT,
