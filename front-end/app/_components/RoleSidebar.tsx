...
export function RoleSidebar({
  ...
  return (
    <aside className="flex min-h-screen w-full max-w-[275px] shrink-0 self-stretch overflow-x-hidden border-r border-white/10 bg-[#050810] px-3 py-[40px] text-white backdrop-blur-[12px]">
      <div className="flex min-h-full w-full min-w-0 flex-col justify-between px-0">
        ...
        <div className="min-w-0 border-t border-[#2E333D] px-3 pt-[17px]">
          <RoleSwitcher
            initialRole={role}
            variant="card"
