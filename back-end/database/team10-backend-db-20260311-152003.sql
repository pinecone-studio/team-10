...
CREATE INDEX idx_offices_office_name ON offices(office_name);
CREATE INDEX idx_order_processes_process_name ON order_processes(process_name);
CREATE INDEX idx_orders_user ON orders(user);
CREATE INDEX idx_orders_office_id ON orders(office_id);
CREATE INDEX idx_orders_order_process_id ON orders(order_process_id);
CREATE INDEX idx_orders_status ON orders(status);
CREATE INDEX idx_orders_expected_arrival_at ON orders(expected_arrival_at);
...
CREATE INDEX idx_order_item_images_sort_order ON order_item_images(sort_order);
CREATE INDEX idx_order_item_attributes_order_item_id ON order_item_attributes(order_item_id);
CREATE INDEX idx_order_item_attributes_name_value ON order_item_attributes(attribute_name, attribute_value);
CREATE INDEX idx_receives_order_id ON receives(order_id);
CREATE INDEX idx_receives_received_by_user_id ON receives(received_by_user_id);
CREATE INDEX idx_receives_office_id ON receives(office_id);
CREATE INDEX idx_receives_status ON receives(status);
...
CREATE INDEX idx_asset_attributes_name_value ON asset_attributes(attribute_name, attribute_value);
CREATE INDEX idx_asset_assignment_requests_asset_id ON asset_assignment_requests(asset_id);
CREATE INDEX idx_asset_assignment_requests_employee_id ON asset_assignment_requests(employee_id);
CREATE INDEX idx_asset_assignment_requests_status ON asset_assignment_requests(status);
CREATE INDEX idx_asset_distributions_asset_id ON asset_distributions(asset_id);
CREATE INDEX idx_asset_distributions_employee_id ON asset_distributions(employee_id);
CREATE INDEX idx_asset_distributions_status ON asset_distributions(status);
